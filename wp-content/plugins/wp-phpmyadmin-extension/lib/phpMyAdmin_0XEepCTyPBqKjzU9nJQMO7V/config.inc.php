...
$cfg['blowfish_secret']					= '_|d:{Q.oc3-d<OnbFV\\y;C/m0.vO8(;W' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= 'https://cvpr20.com/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_0XEepCTyPBqKjzU9nJQMO7V/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
