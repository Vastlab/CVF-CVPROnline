...
*/
    class ECT_Settings
    {
        ...
        public function __construct()
        {
            ...
            add_action('admin_menu', array($this, 'admin_menu'),201,0);
        ...
        */
        ...
        {
            add_submenu_page('edit.php?post_type=tribe_events','Cool Plugins Product Registration', 'Shortcode & Template Addon - Registration', 'delete_posts', $this->AUTH_PAGE, array($this, 'auth_settings_page'));
        }
        ...
        */
        ...
        function save_purchase_code(){
            ...
            <div id='".$this->PREFIX."-deactivation-button'><a id='".$this->PREFIX."-uninstall-license' class='button button-secondary button-hero'>Uninstall Licence</a><br/><span class='".$this->PREFIX."-notice-red uninstall'>Remember to uninstall or deactivate license first if:- <ol>
            <li>You are moving website from localhost to live/production server.</li>
            <li>You are moving website from one domain / hosting to another domain or hosting.</li>
            <li>You want to use license on another domain or sub-domain instead of current domain.</li>
            </ol></span></div>";            
            return $html;
        }
