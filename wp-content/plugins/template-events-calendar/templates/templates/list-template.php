...
/*** CVPR conf Boult List Style 4 */
	...
	$events_html.='<div class="tb-list-post-right">
                ...
                . '<div class="Authorlist"  style="font-size:16px">   &nbsp; &nbsp; Authors: '. conf_get_authors($event_id). '&nbsp; &nbsp; <br/> &nbsp; &nbsp;  <span class="keywords" style="font-size:14px" > <em> Keywords: &nbsp;'. conf_get_keywords($event_id).'</em></span> </br></div>'
