...
class WiseChatAppearanceTab extends WiseChatAbstractTab {
	...
	public function getFields() {
		return array(
			...
			array(
				...
				'HTML template of info windows. Dynamic variables: {profileLink}, {profileLinkInNewWindow}, {role}, {roles}, {profileURL}, {avatar}, {privateMessageButton}, {id}, {username}, {displayname}'),
			...
			array('fb_users_list_top_offset', 'Top Offset', 'stringFieldCallback', 'integer',
				'Moves the chat down by defined offset (in <strong>px</strong> unit). It is useful when the chat covers a top toolbar or menu.'
			),
			array('fb_bottom_offset', 'Bottom Offset', 'stringFieldCallback', 'integer',
				'Moves the chat up by defined offset (in <strong>px</strong> unit). It is useful when the chat covers a bottom toolbar or menu.'
			),
	...
	public function getDefaultValues() {
		return array(
			...
			'autohide_users_list' => 1,
			'autohide_users_list_width' => 350,
