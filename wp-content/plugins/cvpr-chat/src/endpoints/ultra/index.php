...
// make sure it is used only for "Cvpr_chat_messages_endpoint" action:
if (!isset($_REQUEST['action']) || $_REQUEST['action'] !== 'Cvpr_chat_messages_endpoint') {
	header('HTTP/1.0 404 Not Found');
	die('');
}
...
// get a message:
$channelsTable = $variables['table_prefix'].'Cvpr_chat_channels';
$messagesTable = $variables['table_prefix'].'Cvpr_chat_messages';
