...
/**
 * CVPR Chat images post-filter.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatImagesPostFilter {
	const SHORTCODE_REGEXP = '/\[img id=&quot;(\d+)&quot; src=&quot;(.+?)&quot; src-th=&quot;(.+?)&quot; src-org=&quot;(.+?)&quot;\]/i';
	const URL_PROTOCOLS_REGEXP = "/^(https|http|ftp)\:\/\//i";
    const IMAGE_TAG_TEMPLATE = '<a href="%s" target="_blank" data-lightbox="Cvpr_chat" rel="lightbox[Cvpr_chat]"><img src="%s" class="wcImage" alt="Chat image" /></a>';
