...
/**
 * CVPRChat class for accessing plugin options.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatOptions {
	const OPTIONS_NAME = 'Cvpr_chat_options_name';
	const LAST_NAME_ID_OPTION = 'Cvpr_chat_last_name_id';
	...
	*/
	...
	private function __construct() {
		$this->options = get_option(CVPRChatOptions::OPTIONS_NAME);
	}
	
	public static function getInstance() {
		if (self::$instance === null) {
			$instance = new CVPRChatOptions();
	...
	*/
	public function saveOptions() {
		update_option(CVPRChatOptions::OPTIONS_NAME, $this->options);
	}
	...
	*/
	public function dropAllOptions() {
		delete_option(CVPRChatOptions::OPTIONS_NAME);
		delete_option(CVPRChatOptions::LAST_NAME_ID_OPTION);
	}
