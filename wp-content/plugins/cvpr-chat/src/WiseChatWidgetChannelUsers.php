...
/**
 * CVPR Chat widget for displaying users of a channel.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatWidgetChannelUsers extends WP_Widget {

	public function __construct() {
		$widgetOps = array('classname' => 'CVPRChatWidgetChannelUsers', 'description' => 'Displays CVPR Chat channel users' );
		parent::__construct('CVPRChatWidgetChannelUsers', 'CVPR Chat Channel Users', $widgetOps);
	}
	...
	public function form($instance) {
		...
		<p class="description">You can use here the same attributes as in [Cvpr-chat] shortcode.</p>
		<?php
	}
	...
	public function widget($args, $instance) {
		...
		echo $CvprChat->getRenderedChannelUsersShortcode($parsedOptions);
