...
/**
 * CVPRChat DI container.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatContainer {
	/**
	...
	*/
	...
	public static function getLazy($classPathAndName) {
		...
		self::$proxies[$classPathAndName] = new CVPRChatContainerProxyClass($classPathAndName);
...
/**
 * CVPR Chat DI proxy class.
 */
class CVPRChatContainerProxyClass {
	/**
	 * @var string
	 */
	...
	/**
	 * CVPRChatContainerProxyClass constructor.
	 *
	 * @param string $classPathAndName
	 */
	...
	public function __call($name, $arguments) {
		if ($this->targetClassObject === null) {
			$this->targetClassObject = CVPRChatContainer::get($this->targetClassPathAndName);
		}
