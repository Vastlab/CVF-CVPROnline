...
/**
 * CVPR Chat admin advanced settings tab class.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatAdvancedTab extends CVPRChatAbstractTab {
	...
	public function getFields() {
		return array(
			...
			array(
				...
				CVPRChatAdvancedTab::getAllEngines()
			),
			array(
				...
				CVPRChatAdvancedTab::getRefreshTimes()
			),
