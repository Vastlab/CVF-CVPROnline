...
/**
 * CVPR Chat admin emoticons settings tab class.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatEmoticonsTab extends CVPRChatAbstractTab {
	...
	public function getFields() {
		return array(
			...
			array('custom_emoticons_emoticon_width', 'Emoticon Width In Chat', 'selectCallback', 'string', 'Width of a single emoticon in the chat window.', CVPRChatEmoticonsTab::getImageSizes()),
	...
	public function emoticonAddCallback() {
		$url = admin_url("options-general.php?page=".CVPRChatSettings::MENU_SLUG."&wc_action=addEmoticon");
		...
		printf(
			...
			'<p class="description wcProDescription">Notice: This feature is available after upgrading to CVPR Chat Pro.
				<a class="button-secondary wcAdminButtonPro" target="_blank" href="https://kaine.pl/projects/wp-plugins/Cvpr-chat-pro?source=pro-field" title="Check CVPR Chat Pro">Check CVPR Chat <strong>Pro</strong></a>
			</p>',
			wp_nonce_url($url)
		);
	}
	...
	public function emoticonsCallback() {
		...
		$html .= "</table>";
		$html .= '<p class="description wcProDescription">Notice: This feature is available after upgrading to CVPR Chat Pro.
			<a class="button-secondary wcAdminButtonPro" target="_blank" href="https://kaine.pl/projects/wp-plugins/Cvpr-chat-pro?source=pro-field" title="Check CVPR Chat Pro">Check CVPR Chat <strong>Pro</strong></a>
		</p>';
