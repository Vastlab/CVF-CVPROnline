...
/**
 * CVPR Chat admin kicks settings tab class.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatKicksTab extends CVPRChatAbstractTab {
	...
	public function kickAddCallback() {
		$url = admin_url("options-general.php?page=".CVPRChatSettings::MENU_SLUG."&wc_action=addKick");
