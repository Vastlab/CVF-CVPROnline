...
/**
 * CVPR Chat admin messages filters tab class.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatFiltersTab extends CVPRChatAbstractTab {
	...
	public function filterAddCallback() {
		$url = admin_url("options-general.php?page=".CVPRChatSettings::MENU_SLUG."&wc_action=addFilter");
