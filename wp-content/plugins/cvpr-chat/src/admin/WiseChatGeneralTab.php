...
/**
 * CVPR Chat admin general settings tab class.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatGeneralTab extends CVPRChatAbstractTab {
	...
	public static function getAllModes() {
		return array(
			'' => 'Classic chat',
			'_DISABLED_pro_fb' => 'Facebook-like chat (available in CVPR Chat Pro)',
		);
	}
	...
	public function resetSettingsAction() {
		...
		CVPRChatContainer::get('CVPRChatSettings')->setDefaultSettings();
	...
	public function openingHoursCallback($args) {
		...
		$openingModesSelect = sprintf(
			...
			CVPRChatOptions::OPTIONS_NAME, $id,
	...
	public function adminActionsCallback() {
		$url = admin_url("options-general.php?page=".CVPRChatSettings::MENU_SLUG."&wc_action=resetAnonymousCounter");
		$urlResetSettings = admin_url("options-general.php?page=".CVPRChatSettings::MENU_SLUG."&wc_action=resetSettings");
