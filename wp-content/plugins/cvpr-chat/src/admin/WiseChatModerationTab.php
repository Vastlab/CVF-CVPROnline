...
/**
 * CVPR Chat admin moderation settings tab class.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatModerationTab extends CVPRChatAbstractTab {
	...
	public function getFields() {
		return array(
			...
			array(
				...
				'User roles allowed to edit posted messages.<br /> Alternatively you can assign "Cvpr_chat_edit_message" capability to any custom role.', self::getRoles()
			),
			array(
				'permission_delete_message_role', 'Delete Message Permission', 'checkboxesCallback', 'multivalues',
				'User roles allowed to delete posted messages.<br /> Alternatively you can assign "Cvpr_chat_delete_message" capability to any custom role.', self::getRoles()
			),
			array(
				'permission_ban_user_role', 'Ban User Permission', 'checkboxesCallback', 'multivalues',
				'User roles allowed to ban users.<br /> Alternatively you can assign "Cvpr_chat_ban_user" capability to any custom role.', self::getRoles()
			),
			array(
				'permission_kick_user_role', 'Kick User Permission', 'checkboxesCallback', 'multivalues',
				'User roles allowed to kick users.<br /> Alternatively you can assign "Cvpr_chat_kick_user" capability to any custom role.', self::getRoles()
			),
			array(
				'permission_approve_message_role', 'Approve Message Permission', 'checkboxesCallback', 'multivalues',
				'User roles allowed to approve posted messages.<br />Alternatively you can assign "Cvpr_chat_approve_message" capability to any custom role.<br />',
				self::getRoles()
			),
			...
			array(
				...
				'User roles allowed to report spam messages.<br /> Alternatively you can assign "Cvpr_chat_spam_report" capability to any custom role.', self::getRoles()
			),
	...
	public function getDefaultValues() {
		return array(
			...
			'spam_report_subject' => '[CVPR Chat] Spam Report',
			'spam_report_content' => "CVPR Chat Spam Report\n\n".
				'Channel: ${channel}'."\n".
				'Message: ${message}'."\n".
