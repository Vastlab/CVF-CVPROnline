...
/**
 * CVPR Chat admin bans settings tab class.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatBansTab extends CVPRChatAbstractTab {
	...
	public function banAddCallback() {
		$url = admin_url("options-general.php?page=".CVPRChatSettings::MENU_SLUG."&wc_action=addBan");
