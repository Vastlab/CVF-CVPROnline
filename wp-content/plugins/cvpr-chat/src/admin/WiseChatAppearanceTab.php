...
/**
 * CVPR Chat admin appearance settings tab class.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatAppearanceTab extends CVPRChatAbstractTab {
	...
	public function getFields() {
		return array(
			...
			array(
				...
				array_merge(CVPRChatThemes::getAllThemes(), array(
					'_DISABLED_pro_1' => 'Crystal (available in CVPR Chat Pro)',
					'_DISABLED_pro_2' => 'Clear (available in CVPR Chat Pro)',
					'_DISABLED_pro_3' => 'Balloon (available in CVPR Chat Pro)',
				))
			),
			...
			array('text_size_chat', 'Font Size', 'selectCallback', 'string', '', CVPRChatAppearanceTab::getFontSizes()),
			...
			array('messages_order', 'Messages Order', 'selectCallback', 'string', 'Sorting order of the messages', CVPRChatAppearanceTab::getSortingOrder()),
			...
			array('text_size', 'Font Size', 'selectCallback', 'string', '', CVPRChatAppearanceTab::getFontSizes()),
			
			array('messages_time_mode', 'Message Time Mode', 'selectCallback', 'string', 'Format of the date and time displayed next to each message', CVPRChatAppearanceTab::getTimeModes()),
			array(
			...
			array('link_wp_user_name', 'Username Display Mode', 'selectCallback', 'string', '
			    ...
			    ', CVPRChatAppearanceTab::getUserNameLinkModes()),
			...
			array('input_controls_location', 'Input Controls Location', 'selectCallback', 'string', 'Location of the input field, submit button and customizations panel section', CVPRChatAppearanceTab::getInputFieldLocation()),
			...
			array('text_size_users_list', 'Font Size', 'selectCallback', 'string', 'Font size', CVPRChatAppearanceTab::getFontSizes()),
			...
			array(
				...
				'<a href="https://kaine.pl/projects/wp-plugins/Cvpr-chat-pro/documentation/features/private-chat-button/">Read more</a>'
			),
	...
	public function textColorUserRolesCallback() {
		...
		foreach ($roles as $roleSlug => $roleName) {
			...
			printf(
				'<tr>'.
				'<td>%s:&nbsp;</td><td><input type="text" id="text_color_user_roles_%s" name="'.CVPRChatOptions::OPTIONS_NAME.'[text_color_user_roles][%s]" value="%s" class="wc-color-picker" /> </td>'.
				'</tr>',
