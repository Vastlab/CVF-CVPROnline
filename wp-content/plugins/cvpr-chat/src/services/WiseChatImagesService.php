...
/**
 * CVPR Chat image services class.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatImagesService {
	const UPLOAD_FILE_NAME = '_Cvpr_chat_upload';
	...
	*/
	public function getPreparedImage($binaryImageData) {
		...
		try {
			...
			/** @var CVPRChatImageEditor $imageEditor */
			$imageEditor = CVPRChatContainer::get('services/CVPRChatImageEditor');
	...
	*/
	private function logError($message) {
		@trigger_error('WordPress CVPR Chat plugin error (ImagesService): '.$message, E_USER_NOTICE);
	}
