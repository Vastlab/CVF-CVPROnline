...
CVPRChatContainer::load('commands/CVPRChatAbstractCommand');

/**
 * CVPRChat commands resolver.
 *
 * @author Kainex <contact@kaine.pl>
 */
class CVPRChatCommandsResolver {
	...
	* @param CVPRChatUser $systemUser
	* @param CVPRChatChannel $channel Name of the channel
	...
	*/
	...
	private function getClassNameFromCommand($command) {
		...
		return "CVPRChat{$commandName}Command";
	}
}