...
CVPRChatContainer::load('rendering/filters/post/CVPRChatImagesPostFilter');

class CVPRChatImagesPostFilterTest extends PHPUnit_Framework_TestCase {
	/**
	 * @dataProvider data
	 */
    public function testPositiveImages($input, $output) {
		$input = str_replace('"', '&quot;', $input);
        $postFilter = new CVPRChatImagesPostFilter();
    ...
    public function data() {
		return array(
			array(
				...
				'<a href="http://www.poznan.pl/sdsd.jpg" target="_blank" data-lightbox="Cvpr_chat" rel="lightbox[Cvpr_chat]"><img src="http://www.poznan.pl/sdsd-th.jpg" class="wcImage" /></a>'
			),
			array(
				'H: [img id="1" src="http://www.poznan.pl/sdsd.jpg?aaa=%20ss" src-th="http://www.poznan.pl/sdsd-th.jpg?bbb=%20ss" src-org="ORG"]', 
				'H: <a href="http://www.poznan.pl/sdsd.jpg?aaa=%20ss" target="_blank" data-lightbox="Cvpr_chat" rel="lightbox[Cvpr_chat]"><img src="http://www.poznan.pl/sdsd-th.jpg?bbb=%20ss" class="wcImage" /></a>'
			),
			array(
				...
				'H: <a href="http://www.poznan.pl/sdsd.jpg?aaa=%20ss" target="_blank" data-lightbox="Cvpr_chat" rel="lightbox[Cvpr_chat]"><img src="http://www.poznan.pl/sdsd-th.jpg?bbb=%20ss" class="wcImage" /></a> x <a href="http://www.poznan.pl/www.jpg?aaa=%20ss" target="_blank" data-lightbox="Cvpr_chat" rel="lightbox[Cvpr_chat]"><img src="http://www.poznan.pl/www-th.jpg?bbb=%20ss" class="wcImage" /></a>'
			),
		);
    }
