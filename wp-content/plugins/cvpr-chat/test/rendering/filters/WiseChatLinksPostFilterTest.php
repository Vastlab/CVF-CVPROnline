...
CVPRChatContainer::load('rendering/filters/post/CVPRChatLinksPostFilter');

class CVPRChatLinksPostFilterTest extends PHPUnit_Framework_TestCase {
    ...
    public function testPositiveNoLinks($input, $output) {
        ...
        $filter = new CVPRChatLinksPostFilter();
