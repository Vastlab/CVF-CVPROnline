...
CVPRChatContainer::load('rendering/filters/pre/CVPRChatLinksPreFilter');
CVPRChatContainer::load('rendering/filters/CVPRChatShortcodeConstructor');
CVPRChatContainer::load('services/CVPRChatImagesService');
CVPRChatContainer::load('services/user/CVPRChatActions');
CVPRChatContainer::load('services/user/CVPRChatAuthentication');

class CVPRChatLinksPreFilterTest extends PHPUnit_Framework_TestCase {
	
	/**
	 * @dataProvider dataNoImages
	 */
    public function testPositiveNoImages($input, $output) {
        CVPRChatContainer::replace('services/user/CVPRChatActions', new CVPRChatActionsStub());
        CVPRChatContainer::replace('services/CVPRChatImagesService', new CVPRChatImagesServiceStub());
        CVPRChatContainer::replace('services/user/CVPRChatAuthentication', new CVPRChatAuthenticationStub());
		$linksPreFilter = new CVPRChatLinksPreFilter();
...
class CVPRChatImagesServiceStub extends CVPRChatImagesService {
...
class CVPRChatActionsStub extends CVPRChatActions {
	public function __construct() { }
}

class CVPRChatAuthenticationStub extends CVPRChatAuthentication {
	public function __construct() { }
}