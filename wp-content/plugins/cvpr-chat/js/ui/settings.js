/**
 * CVPR Chat user's settings support.
 *
 * @author Kainex <contact@kaine.pl>
 */
function CVPRChatSettings(options, messages) {
	var settingsEndpoint = options.apiEndpointBase + '?action=Cvpr_chat_settings_endpoint';
