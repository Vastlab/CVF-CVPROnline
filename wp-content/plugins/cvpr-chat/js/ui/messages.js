/**
 * CVPR Chat messages sending and displaying. 
 *
 * @author Kainex <contact@kaine.pl>
 */
function CVPRChatMessages(options, messagesHistory, messageAttachments, dateAndTimeRenderer, notifier, progressBar) {
	...
	var messagesEndpoint = options.apiMessagesEndpointBase + '?action=Cvpr_chat_messages_endpoint';
	var messageEndpoint = options.apiWPEndpointBase + '?action=Cvpr_chat_message_endpoint';
	var messageDeleteEndpoint = options.apiWPEndpointBase + '?action=Cvpr_chat_delete_message_endpoint';
	var userBanEndpoint = options.apiWPEndpointBase + '?action=Cvpr_chat_user_ban_endpoint';
	var userKickEndpoint = options.apiWPEndpointBase + '?action=Cvpr_chat_user_kick_endpoint';
	var spamReportEndpoint = options.apiWPEndpointBase + '?action=Cvpr_chat_spam_report_endpoint';
