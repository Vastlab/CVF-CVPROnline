...
/*** CVPR conf Boult List Style 4 */
	...
	$event_single_link=esc_url( tribe_get_event_link($event_id));
	$event_title_att=get_the_title($event_id);
    $teasertxt = esc_html_(conf_get_teasertxt($event_id));
    ...
    //	$bg_styles="background-image:url('$teaserpic');background-size:128x 128px; background-repeat: no-repeat;background-position:bottom center;";
        ...
        //       $bg_styles="background-image:url('$teaserpic');background-size:512x 512px; background-repeat: no-repeat;background-position: center;";           
             ...
             $events_html.= ' <div class="ect-list-img" style="'.$bg_styles.'"><img src="'.$teaserpic.'" width=128px height=128px class=center alt="Teaser picture for paper"></div>';
              $events_html.= ' <div class="ect-list-img" style="'.$bg_styles.'"></div>';
    	$events_html.=	' <a class="ect-single-event-link" href="'.$event_single_link.'" title="'.$event_title_att.'"></a>';
	...
	$events_html.='<div class="tb-list-post-right">
                ...
                . '<div class="Teasertxtlist" style="font-size:18px" > '. $teasertxt 
                . '<div class="Authorlist"  style="font-size:16px">   &nbsp; &nbsp; Authors: '. conf_get_authors($event_id)
                 . '&nbsp; &nbsp; <br/> &nbsp; &nbsp;  <span class="keywords" style="font-size:14px" > <em> Keywords: &nbsp;'
                 . esc_html_(conf_get_keywords($event_id)).'</em></span> </br></div>'
                . '</div> ';      //do teaser text instead of contents. allows smaller boxes. 
